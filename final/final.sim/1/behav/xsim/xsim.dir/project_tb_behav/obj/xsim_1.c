...
{
	iki_relocate(dp, "xsim.dir/project_tb_behav/xsim.reloc",  (void **)funcTab, 15);
	iki_vhdl_file_variable_register(dp + 1060656);
	iki_vhdl_file_variable_register(dp + 1060712);
