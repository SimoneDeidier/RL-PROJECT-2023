...
{
	iki_relocate(dp, "xsim.dir/project_tb_func_synth/xsim.reloc",  (void **)funcTab, 159);
	iki_vhdl_file_variable_register(dp + 1272456);
	iki_vhdl_file_variable_register(dp + 1272512);
